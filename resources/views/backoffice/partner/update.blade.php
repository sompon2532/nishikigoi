                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="website" value="{{ $partner->website }}" id="website" placeholder="Website">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="email" value="{{ $partner->email }}" id="email" placeholder="E-mail">
                            </div>
                        </div>
